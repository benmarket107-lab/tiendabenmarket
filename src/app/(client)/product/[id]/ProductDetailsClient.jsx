...
export default function ProductDetailsClient({ initialProduct = null }) {
  ...
  const product = productById[decodedId] || productById[id] || initialProduct;
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
        ...
        <div className="flex flex-col justify-center">
          ...
          <h1 className="text-3xl sm:text-4xl font-black text-slate-900 leading-tight mb-4 font-headline">
            {product.name}
