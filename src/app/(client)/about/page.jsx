...
export const metadata = {
  title: 'Nuestra Historia | Benmarket Express',
  description: 'Conoce la historia de Benmarket, cómo empezamos y cuáles son nuestros valores.',
};
