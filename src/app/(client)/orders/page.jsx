...
export default function OrdersPage() {
  ...
  const handleHideOrder = async (e, id) => {
    e.stopPropagation();
    if (typeof window !== 'undefined' && !window.confirm('¿Estás seguro de que quieres eliminar este pedido de tu historial?')) return;
    ...
    <div className="w-full bg-surface min-h-screen py-8 sm:py-12 px-4 sm:px-6 lg:px-8 mb-20 md:mb-0">
      <div className="max-w-4xl mx-auto">
        <div className="flex items-start justify-between gap-4 mb-8 sm:mb-10">
          ...
          <Link href="/" className="hidden sm:inline-flex bg-primary text-on-primary px-5 py-3 rounded-xl font-bold hover:bg-primary-container transition-colors">
            Seguir comprando
          </Link>
        </div>
        ...
        {loading ? (
          ...
          <div className="bg-surface-container-lowest rounded-3xl border border-outline-variant/20 shadow-sm p-10 text-center">
            ...
            <Link href="/" className="inline-flex mt-6 bg-primary text-on-primary px-6 py-3 rounded-xl font-bold hover:bg-primary-container transition-colors">
              Ver productos
            </Link>
          </div>
        ) : (
        ...
        <div className="sm:hidden mt-8">
          <Link href="/" className="w-full inline-flex justify-center bg-primary text-on-primary px-6 py-3 rounded-xl font-bold hover:bg-primary-container transition-colors">
            Seguir comprando
          </Link>
        </div>
      </div>
