...
export const metadata = {
  title: 'Términos y Condiciones | Benmarket Express',
  description: 'Conoce los términos y condiciones de uso de la plataforma de compras online de Benmarket Express.',
};
...
export default function TermsAndConditionsPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="mb-8">
        <Link href="/" className="inline-flex items-center text-sm font-bold text-slate-500 hover:text-primary transition-colors mb-6">
