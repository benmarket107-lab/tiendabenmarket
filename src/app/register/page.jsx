    ...
    <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-[rgb(47,47,47)] relative overflow-hidden">
      ...
      <div className="max-w-md w-full space-y-8 relative z-10">
        <div className="text-center">
          ...
          <h2 className="text-4xl font-extrabold text-white tracking-tight">Crear Cuenta</h2>
          <p className="mt-2 text-sm text-slate-300">
            ¿Ya tienes una cuenta?{' '}
            <Link href="/login" className="font-bold text-primary hover:text-primary/90 transition-colors">
              Inicia sesión aquí
            </Link>
          </p>
        </div>
        ...
        <form className="mt-8 space-y-5 bg-white p-8 rounded-3xl shadow-xl shadow-slate-200/50 border border-slate-100" onSubmit={handleSubmit}>
          ...
          <div className="space-y-3 pt-2">
            <button 
              type="submit" 
              disabled={loading}
              className="btn-primary w-full flex justify-center items-center gap-2 py-3.5 text-lg font-bold shadow-lg shadow-primary/25 hover:shadow-primary/30 hover:-translate-y-0.5 transition-all disabled:opacity-50 disabled:pointer-events-none"
            >
